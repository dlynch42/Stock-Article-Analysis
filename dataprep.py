...
# Section 1: Preparing IMDb movie review data for test processing
# Preprocessing Movie Dataset into more convenient format
    # In MLBookScratch.txt
    # Make df = movie_data.csv
df = pd.read_csv('movie_data.csv')

# Section 2: Introducing the Bag-of-Words Model
...
def preprocessor(text):
    text = re.sub('<[^>]*>', '', text)      # remove HTML markup from movie reviews
...
# Apply preprocessor fxn to all movie reviews in df
...
# Section 3: Training LR model for document classification, classify reviews into positive and negative reivews
...
# Section 4: Working with Big Data - Online Algorithms and Out of Core Learning
nltk.download('stopwords')
...
# Section 5: Topic Modeling with Latent Dirichlet Allocation (LDA, not same as chapter 5)
...
# Create pkl object
# Section 1: Serializing Fitted Scikit-Learn Estimators
